namespace SoarCraft.QYun.ArknightsAssetStudio.UnitTest {
    using System;
    using System.IO;
    ...
    public class CoreTests {
        ...
        public void FMODDecodeTest(string filePath, long PathID) {
            ...
            if (!Helpers.ByteArrayToFile(@"C:\CaChe\ArknightsAssetStudio_AudioResult.wav",
        ...
        public void TextureDecodeTest(string filePath, long PathID) {
            ...
            img.SaveAsPng($@"C:\CaChe\ArknightsAssetStudio_TextureResult{DateTime.Now.Ticks}.png");
        }
        ...
        public void ShaderConvertTest(string filePath, long PathID) {
            ...
            File.WriteAllText(@"C:\CaChe\ArknightsAssetStudio_ShaderResult.txt", str);
        }
        ...
        public void ETC1Test(string filePath, long PathID) {
            ...
            if (data is { Length: > 0 }) {
                ...
                image.SaveAsPng($@"C:\CaChe\ArknightsAssetStudio_TextureResult{DateTime.Now.Ticks}.png");
            } else {
                Assert.Fail("数组为空");
            }
        }
