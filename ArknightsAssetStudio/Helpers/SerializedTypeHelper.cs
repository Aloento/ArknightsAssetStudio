namespace SoarCraft.QYun.ArknightsAssetStudio.Helpers {
    ...
    public class SerializedTypeHelper {
        ...
        public SerializedTypeHelper(int[] version) => this.version = version;
        ...
        public void AddPPtr(List<TypeTreeNode> nodes, string type, string name, int indent) {
            ...
            nodes.Add(this.version[0] >= 5
                ? new TypeTreeNode("SInt64", "m_PathID", indent + 1, false)
                : new TypeTreeNode("int", "m_PathID", indent + 1, false));
        }
