...
namespace SoarCraft.QYun.ArknightsAssetStudio {
    using System;
    using Activation;
    using AssetReader;
    ...
    public partial class App : Application {
        ...
        public App() {
            ...
            logger.Information("-------------------------------------");
            logger.Information("Hello, SoarCraft.QYun.ArknightsAssetStudio!");
        }
...
#endif
                .WriteTo.Async(a => a.File(@"C:\CaChe\ArknightsAssetStudio.log"))
                .CreateLogger());
