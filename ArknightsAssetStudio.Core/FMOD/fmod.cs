...
namespace SoarCraft.QYun.ArknightsAssetStudio.Core.FMOD {
    using global::System;
    ...
    */
    public class VERSION {
        ...
        public const string dll = "Natives/fmod64";
    }
...
#pragma warning disable 414
    [StructLayout(LayoutKind.Sequential)]
    public struct REVERB_PROPERTIES {                            /*        MIN     MAX    DEFAULT   DESCRIPTION */
...
#pragma warning restore 414
    ...
    */
    public class PRESET {
        ...
        public static REVERB_PROPERTIES OFF() => new(1000, 7, 11, 5000, 100, 100, 100, 250, 0, 20, 96, -80.0f);
        public static REVERB_PROPERTIES GENERIC() => new(1500, 7, 11, 5000, 83, 100, 100, 250, 0, 14500, 96, -8.0f);
        public static REVERB_PROPERTIES PADDEDCELL() => new(170, 1, 2, 5000, 10, 100, 100, 250, 0, 160, 84, -7.8f);
        public static REVERB_PROPERTIES ROOM() => new(400, 2, 3, 5000, 83, 100, 100, 250, 0, 6050, 88, -9.4f);
        public static REVERB_PROPERTIES BATHROOM() => new(1500, 7, 11, 5000, 54, 100, 60, 250, 0, 2900, 83, 0.5f);
        public static REVERB_PROPERTIES LIVINGROOM() => new(500, 3, 4, 5000, 10, 100, 100, 250, 0, 160, 58, -19.0f);
        public static REVERB_PROPERTIES STONEROOM() => new(2300, 12, 17, 5000, 64, 100, 100, 250, 0, 7800, 71, -8.5f);
        public static REVERB_PROPERTIES AUDITORIUM() => new(4300, 20, 30, 5000, 59, 100, 100, 250, 0, 5850, 64, -11.7f);
        public static REVERB_PROPERTIES CONCERTHALL() => new(3900, 20, 29, 5000, 70, 100, 100, 250, 0, 5650, 80, -9.8f);
        public static REVERB_PROPERTIES CAVE() => new(2900, 15, 22, 5000, 100, 100, 100, 250, 0, 20000, 59, -11.3f);
        public static REVERB_PROPERTIES ARENA() => new(7200, 20, 30, 5000, 33, 100, 100, 250, 0, 4500, 80, -9.6f);
        public static REVERB_PROPERTIES HANGAR() => new(10000, 20, 30, 5000, 23, 100, 100, 250, 0, 3400, 72, -7.4f);
        public static REVERB_PROPERTIES CARPETTEDHALLWAY() => new(300, 2, 30, 5000, 10, 100, 100, 250, 0, 500, 56, -24.0f);
        public static REVERB_PROPERTIES HALLWAY() => new(1500, 7, 11, 5000, 59, 100, 100, 250, 0, 7800, 87, -5.5f);
        public static REVERB_PROPERTIES STONECORRIDOR() => new(270, 13, 20, 5000, 79, 100, 100, 250, 0, 9000, 86, -6.0f);
        public static REVERB_PROPERTIES ALLEY() => new(1500, 7, 11, 5000, 86, 100, 100, 250, 0, 8300, 80, -9.8f);
        public static REVERB_PROPERTIES FOREST() => new(1500, 162, 88, 5000, 54, 79, 100, 250, 0, 760, 94, -12.3f);
        public static REVERB_PROPERTIES CITY() => new(1500, 7, 11, 5000, 67, 50, 100, 250, 0, 4050, 66, -26.0f);
        public static REVERB_PROPERTIES MOUNTAINS() => new(1500, 300, 100, 5000, 21, 27, 100, 250, 0, 1220, 82, -24.0f);
        public static REVERB_PROPERTIES QUARRY() => new(1500, 61, 25, 5000, 83, 100, 100, 250, 0, 3400, 100, -5.0f);
        public static REVERB_PROPERTIES PLAIN() => new(1500, 179, 100, 5000, 50, 21, 100, 250, 0, 1670, 65, -28.0f);
        public static REVERB_PROPERTIES PARKINGLOT() => new(1700, 8, 12, 5000, 100, 100, 100, 250, 0, 20000, 56, -19.5f);
        public static REVERB_PROPERTIES SEWERPIPE() => new(2800, 14, 21, 5000, 14, 80, 60, 250, 0, 3400, 66, 1.2f);
        public static REVERB_PROPERTIES UNDERWATER() => new(1500, 7, 11, 5000, 10, 100, 100, 250, 0, 500, 92, 7.0f);
    }
    ...
    */
    ...
    public class Memory {
        public static RESULT Initialize(IntPtr poolmem, int poollen, MEMORY_ALLOC_CALLBACK useralloc, MEMORY_REALLOC_CALLBACK userrealloc, MEMORY_FREE_CALLBACK userfree, MEMORY_TYPE memtypeflags) => FMOD_Memory_Initialize(poolmem, poollen, useralloc, userrealloc, userfree, memtypeflags);

        public static RESULT GetStats(out int currentalloced, out int maxalloced) => GetStats(out currentalloced, out maxalloced, false);

        public static RESULT GetStats(out int currentalloced, out int maxalloced, bool blocking) => FMOD_Memory_GetStats(out currentalloced, out maxalloced, blocking);
    ...
    public class Debug {
        public static RESULT Initialize(DEBUG_FLAGS flags, DEBUG_MODE mode, DEBUG_CALLBACK callback, string filename) => FMOD_Debug_Initialize(flags, mode, callback, filename);
    ...
    public class HandleBase {
        ...
        public bool Equals(HandleBase p) =>
            ...
            ((object)p != null && this.rawPtr == p.rawPtr);
    ...
    */
    public class System : HandleBase {
        public RESULT release() {
            var result = FMOD_System_Release(this.rawPtr);
            if (result == RESULT.OK) {
        ...
        // Pre-init functions.
        public RESULT setOutput(OUTPUTTYPE output) => FMOD_System_SetOutput(this.rawPtr, output);
        public RESULT getOutput(out OUTPUTTYPE output) => FMOD_System_GetOutput(this.rawPtr, out output);
        public RESULT getNumDrivers(out int numdrivers) => FMOD_System_GetNumDrivers(this.rawPtr, out numdrivers);
        public RESULT getDriverInfo(int id, StringBuilder name, int namelen, out Guid guid, out int systemrate, out SPEAKERMODE speakermode, out int speakermodechannels) {
            ...
            var result = FMOD_System_GetDriverInfo(this.rawPtr, id, stringMem, namelen, out guid, out systemrate, out speakermode, out speakermodechannels);
        ...
        public RESULT setDriver(int driver) => FMOD_System_SetDriver(this.rawPtr, driver);
        public RESULT getDriver(out int driver) => FMOD_System_GetDriver(this.rawPtr, out driver);
        public RESULT setSoftwareChannels(int numsoftwarechannels) => FMOD_System_SetSoftwareChannels(this.rawPtr, numsoftwarechannels);
        public RESULT getSoftwareChannels(out int numsoftwarechannels) => FMOD_System_GetSoftwareChannels(this.rawPtr, out numsoftwarechannels);
        public RESULT setSoftwareFormat(int samplerate, SPEAKERMODE speakermode, int numrawspeakers) => FMOD_System_SetSoftwareFormat(this.rawPtr, samplerate, speakermode, numrawspeakers);
        public RESULT getSoftwareFormat(out int samplerate, out SPEAKERMODE speakermode, out int numrawspeakers) => FMOD_System_GetSoftwareFormat(this.rawPtr, out samplerate, out speakermode, out numrawspeakers);
        public RESULT setDSPBufferSize(uint bufferlength, int numbuffers) => FMOD_System_SetDSPBufferSize(this.rawPtr, bufferlength, numbuffers);
        public RESULT getDSPBufferSize(out uint bufferlength, out int numbuffers) => FMOD_System_GetDSPBufferSize(this.rawPtr, out bufferlength, out numbuffers);
        public RESULT setFileSystem(FILE_OPENCALLBACK useropen, FILE_CLOSECALLBACK userclose, FILE_READCALLBACK userread, FILE_SEEKCALLBACK userseek, FILE_ASYNCREADCALLBACK userasyncread, FILE_ASYNCCANCELCALLBACK userasynccancel, int blockalign) => FMOD_System_SetFileSystem(this.rawPtr, useropen, userclose, userread, userseek, userasyncread, userasynccancel, blockalign);
        public RESULT attachFileSystem(FILE_OPENCALLBACK useropen, FILE_CLOSECALLBACK userclose, FILE_READCALLBACK userread, FILE_SEEKCALLBACK userseek) => FMOD_System_AttachFileSystem(this.rawPtr, useropen, userclose, userread, userseek);
        ...
        public RESULT setCallback(SYSTEM_CALLBACK callback, SYSTEM_CALLBACK_TYPE callbackmask) => FMOD_System_SetCallback(this.rawPtr, callback, callbackmask);

        // Plug-in support.
        public RESULT setPluginPath(string path) => FMOD_System_SetPluginPath(this.rawPtr, Encoding.UTF8.GetBytes(path + char.MinValue));
        public RESULT loadPlugin(string filename, out uint handle, uint priority) => FMOD_System_LoadPlugin(this.rawPtr, Encoding.UTF8.GetBytes(filename + char.MinValue), out handle, priority);
        public RESULT loadPlugin(string filename, out uint handle) => this.loadPlugin(filename, out handle, 0);
        public RESULT unloadPlugin(uint handle) => FMOD_System_UnloadPlugin(this.rawPtr, handle);
        public RESULT getNumPlugins(PLUGINTYPE plugintype, out int numplugins) => FMOD_System_GetNumPlugins(this.rawPtr, plugintype, out numplugins);
        public RESULT getPluginHandle(PLUGINTYPE plugintype, int index, out uint handle) => FMOD_System_GetPluginHandle(this.rawPtr, plugintype, index, out handle);
        public RESULT getPluginInfo(uint handle, out PLUGINTYPE plugintype, StringBuilder name, int namelen, out uint version) {
            var stringMem = Marshal.AllocHGlobal(name.Capacity);

            var result = FMOD_System_GetPluginInfo(this.rawPtr, handle, out plugintype, stringMem, namelen, out version);
        ...
        public RESULT setOutputByPlugin(uint handle) => FMOD_System_SetOutputByPlugin(this.rawPtr, handle);
        public RESULT getOutputByPlugin(out uint handle) => FMOD_System_GetOutputByPlugin(this.rawPtr, out handle);
        public RESULT createDSPByPlugin(uint handle, out DSP dsp) {
            dsp = null;

            var result = FMOD_System_CreateDSPByPlugin(this.rawPtr, handle, out var dspraw);
            dsp = new DSP(dspraw);

            return result;
        }
        public RESULT getDSPInfoByPlugin(uint handle, out IntPtr description) => FMOD_System_GetDSPInfoByPlugin(this.rawPtr, handle, out description);
        /*
        ...
        */
        public RESULT registerDSP(ref DSP_DESCRIPTION description, out uint handle) => FMOD_System_RegisterDSP(this.rawPtr, ref description, out handle);
        /*
        ...
        */
        ...
        // Init/Close.
        public RESULT init(int maxchannels, INITFLAGS flags, IntPtr extradriverdata) => FMOD_System_Init(this.rawPtr, maxchannels, flags, extradriverdata);
        public RESULT close() => FMOD_System_Close(this.rawPtr);


        // General post-init system functions.
        public RESULT update() => FMOD_System_Update(this.rawPtr);

        public RESULT setSpeakerPosition(SPEAKER speaker, float x, float y, bool active) => FMOD_System_SetSpeakerPosition(this.rawPtr, speaker, x, y, active);
        public RESULT getSpeakerPosition(SPEAKER speaker, out float x, out float y, out bool active) => FMOD_System_GetSpeakerPosition(this.rawPtr, speaker, out x, out y, out active);
        public RESULT setStreamBufferSize(uint filebuffersize, TIMEUNIT filebuffersizetype) => FMOD_System_SetStreamBufferSize(this.rawPtr, filebuffersize, filebuffersizetype);
        public RESULT getStreamBufferSize(out uint filebuffersize, out TIMEUNIT filebuffersizetype) => FMOD_System_GetStreamBufferSize(this.rawPtr, out filebuffersize, out filebuffersizetype);
        public RESULT set3DSettings(float dopplerscale, float distancefactor, float rolloffscale) => FMOD_System_Set3DSettings(this.rawPtr, dopplerscale, distancefactor, rolloffscale);
        public RESULT get3DSettings(out float dopplerscale, out float distancefactor, out float rolloffscale) => FMOD_System_Get3DSettings(this.rawPtr, out dopplerscale, out distancefactor, out rolloffscale);
        public RESULT set3DNumListeners(int numlisteners) => FMOD_System_Set3DNumListeners(this.rawPtr, numlisteners);
        public RESULT get3DNumListeners(out int numlisteners) => FMOD_System_Get3DNumListeners(this.rawPtr, out numlisteners);
        public RESULT set3DListenerAttributes(int listener, ref VECTOR pos, ref VECTOR vel, ref VECTOR forward, ref VECTOR up) => FMOD_System_Set3DListenerAttributes(this.rawPtr, listener, ref pos, ref vel, ref forward, ref up);
        public RESULT get3DListenerAttributes(int listener, out VECTOR pos, out VECTOR vel, out VECTOR forward, out VECTOR up) => FMOD_System_Get3DListenerAttributes(this.rawPtr, listener, out pos, out vel, out forward, out up);
        public RESULT set3DRolloffCallback(CB_3D_ROLLOFFCALLBACK callback) => FMOD_System_Set3DRolloffCallback(this.rawPtr, callback);
        public RESULT mixerSuspend() => FMOD_System_MixerSuspend(this.rawPtr);
        public RESULT mixerResume() => FMOD_System_MixerResume(this.rawPtr);
        public RESULT getDefaultMixMatrix(SPEAKERMODE sourcespeakermode, SPEAKERMODE targetspeakermode, float[] matrix, int matrixhop) => FMOD_System_GetDefaultMixMatrix(this.rawPtr, sourcespeakermode, targetspeakermode, matrix, matrixhop);
        public RESULT getSpeakerModeChannels(SPEAKERMODE mode, out int channels) => FMOD_System_GetSpeakerModeChannels(this.rawPtr, mode, out channels);

        // System information functions.
        public RESULT getVersion(out uint version) => FMOD_System_GetVersion(this.rawPtr, out version);
        public RESULT getOutputHandle(out IntPtr handle) => FMOD_System_GetOutputHandle(this.rawPtr, out handle);
        public RESULT getChannelsPlaying(out int channels) => FMOD_System_GetChannelsPlaying(this.rawPtr, out channels);
        public RESULT getChannelsReal(out int channels) => FMOD_System_GetChannelsReal(this.rawPtr, out channels);
        public RESULT getCPUUsage(out float dsp, out float stream, out float geometry, out float update, out float total) => FMOD_System_GetCPUUsage(this.rawPtr, out dsp, out stream, out geometry, out update, out total);
        public RESULT getSoundRAM(out int currentalloced, out int maxalloced, out int total) => FMOD_System_GetSoundRAM(this.rawPtr, out currentalloced, out maxalloced, out total);
        ...
        public RESULT createSound(string name, MODE mode, ref CREATESOUNDEXINFO exinfo, out Sound sound) {
            ...
            var result = FMOD_System_CreateSound(this.rawPtr, stringData, mode, ref exinfo, out var soundraw);
        ...
        public RESULT createSound(byte[] data, MODE mode, ref CREATESOUNDEXINFO exinfo, out Sound sound) {
            ...
            var result = FMOD_System_CreateSound(this.rawPtr, data, mode, ref exinfo, out var soundraw);
            sound = new Sound(soundraw);
        ...
        public RESULT createStream(string name, MODE mode, ref CREATESOUNDEXINFO exinfo, out Sound sound) {
            ...
            var result = FMOD_System_CreateStream(this.rawPtr, stringData, mode, ref exinfo, out var soundraw);
            sound = new Sound(soundraw);
        ...
        public RESULT createStream(byte[] data, MODE mode, ref CREATESOUNDEXINFO exinfo, out Sound sound) {
            ...
            var result = FMOD_System_CreateStream(this.rawPtr, data, mode, ref exinfo, out var soundraw);
            sound = new Sound(soundraw);
        ...
        public RESULT createDSP(ref DSP_DESCRIPTION description, out DSP dsp) {
            ...
            var result = FMOD_System_CreateDSP(this.rawPtr, ref description, out var dspraw);
            dsp = new DSP(dspraw);
        ...
        public RESULT createDSPByType(DSP_TYPE type, out DSP dsp) {
            ...
            var result = FMOD_System_CreateDSPByType(this.rawPtr, type, out var dspraw);
            dsp = new DSP(dspraw);
        ...
        public RESULT createChannelGroup(string name, out ChannelGroup channelgroup) {
            ...
            var result = FMOD_System_CreateChannelGroup(this.rawPtr, stringData, out var channelgroupraw);
        ...
        public RESULT createSoundGroup(string name, out SoundGroup soundgroup) {
            ...
            var result = FMOD_System_CreateSoundGroup(this.rawPtr, stringData, out var soundgroupraw);
            soundgroup = new SoundGroup(soundgroupraw);

            return result;
        }
        public RESULT createReverb3D(out Reverb3D reverb) {
            var result = FMOD_System_CreateReverb3D(this.rawPtr, out var reverbraw);
        ...
        public RESULT playSound(Sound sound, ChannelGroup channelGroup, bool paused, out Channel channel) {
            ...
            var result = FMOD_System_PlaySound(this.rawPtr, sound.getRaw(), channelGroupRaw, paused, out var channelraw);
        ...
        public RESULT playDSP(DSP dsp, ChannelGroup channelGroup, bool paused, out Channel channel) {
            ...
            var result = FMOD_System_PlayDSP(this.rawPtr, dsp.getRaw(), channelGroupRaw, paused, out var channelraw);
            channel = new Channel(channelraw);
        ...
        public RESULT getChannel(int channelid, out Channel channel) {
            ...
            var result = FMOD_System_GetChannel(this.rawPtr, channelid, out var channelraw);
            channel = new Channel(channelraw);
        ...
        public RESULT getMasterChannelGroup(out ChannelGroup channelgroup) {
            ...
            var result = FMOD_System_GetMasterChannelGroup(this.rawPtr, out var channelgroupraw);
            channelgroup = new ChannelGroup(channelgroupraw);
        ...
        public RESULT getMasterSoundGroup(out SoundGroup soundgroup) {
            ...
            var result = FMOD_System_GetMasterSoundGroup(this.rawPtr, out var soundgroupraw);
            soundgroup = new SoundGroup(soundgroupraw);
        ...
        // Routing to ports.
        public RESULT attachChannelGroupToPort(uint portType, ulong portIndex, ChannelGroup channelgroup, bool passThru = false) => FMOD_System_AttachChannelGroupToPort(this.rawPtr, portType, portIndex, channelgroup.getRaw(), passThru);
        public RESULT detachChannelGroupFromPort(ChannelGroup channelgroup) => FMOD_System_DetachChannelGroupFromPort(this.rawPtr, channelgroup.getRaw());

        // Reverb api.
        public RESULT setReverbProperties(int instance, ref REVERB_PROPERTIES prop) => FMOD_System_SetReverbProperties(this.rawPtr, instance, ref prop);
        public RESULT getReverbProperties(int instance, out REVERB_PROPERTIES prop) => FMOD_System_GetReverbProperties(this.rawPtr, instance, out prop);

        // System level DSP functionality.
        public RESULT lockDSP() => FMOD_System_LockDSP(this.rawPtr);
        public RESULT unlockDSP() => FMOD_System_UnlockDSP(this.rawPtr);

        // Recording api
        public RESULT getRecordNumDrivers(out int numdrivers, out int numconnected) => FMOD_System_GetRecordNumDrivers(this.rawPtr, out numdrivers, out numconnected);
        public RESULT getRecordDriverInfo(int id, StringBuilder name, int namelen, out Guid guid, out int systemrate, out SPEAKERMODE speakermode, out int speakermodechannels, out DRIVER_STATE state) {
            ...
            var result = FMOD_System_GetRecordDriverInfo(this.rawPtr, id, stringMem, namelen, out guid, out systemrate, out speakermode, out speakermodechannels, out state);
        ...
        public RESULT getRecordPosition(int id, out uint position) => FMOD_System_GetRecordPosition(this.rawPtr, id, out position);
        public RESULT recordStart(int id, Sound sound, bool loop) => FMOD_System_RecordStart(this.rawPtr, id, sound.getRaw(), loop);
        public RESULT recordStop(int id) => FMOD_System_RecordStop(this.rawPtr, id);
        public RESULT isRecording(int id, out bool recording) => FMOD_System_IsRecording(this.rawPtr, id, out recording);

        // Geometry api
        public RESULT createGeometry(int maxpolygons, int maxvertices, out Geometry geometry) {
            geometry = null;

            var result = FMOD_System_CreateGeometry(this.rawPtr, maxpolygons, maxvertices, out var geometryraw);
            geometry = new Geometry(geometryraw);

            return result;
        }
        public RESULT setGeometrySettings(float maxworldsize) => FMOD_System_SetGeometrySettings(this.rawPtr, maxworldsize);
        public RESULT getGeometrySettings(out float maxworldsize) => FMOD_System_GetGeometrySettings(this.rawPtr, out maxworldsize);
        public RESULT loadGeometry(IntPtr data, int datasize, out Geometry geometry) {
            geometry = null;

            var result = FMOD_System_LoadGeometry(this.rawPtr, data, datasize, out var geometryraw);
            geometry = new Geometry(geometryraw);

            return result;
        }
        public RESULT getGeometryOcclusion(ref VECTOR listener, ref VECTOR source, out float direct, out float reverb) => FMOD_System_GetGeometryOcclusion(this.rawPtr, ref listener, ref source, out direct, out reverb);

        // Network functions
        public RESULT setNetworkProxy(string proxy) => FMOD_System_SetNetworkProxy(this.rawPtr, Encoding.UTF8.GetBytes(proxy + char.MinValue));
        public RESULT getNetworkProxy(StringBuilder proxy, int proxylen) {
            var stringMem = Marshal.AllocHGlobal(proxy.Capacity);

            var result = FMOD_System_GetNetworkProxy(this.rawPtr, stringMem, proxylen);
        ...
        public RESULT setNetworkTimeout(int timeout) => FMOD_System_SetNetworkTimeout(this.rawPtr, timeout);
        public RESULT getNetworkTimeout(out int timeout) => FMOD_System_GetNetworkTimeout(this.rawPtr, out timeout);

        // Userdata set/get
        public RESULT setUserData(IntPtr userdata) => FMOD_System_SetUserData(this.rawPtr, userdata);
        public RESULT getUserData(out IntPtr userdata) => FMOD_System_GetUserData(this.rawPtr, out userdata);
    ...
    */
    public class Sound : HandleBase {
        public RESULT release() {
            var result = FMOD_Sound_Release(this.rawPtr);
            if (result == RESULT.OK) {
                this.rawPtr = IntPtr.Zero;
            }
            return result;
        ...
        public RESULT getSystemObject(out System system) {
            ...
            var result = FMOD_Sound_GetSystemObject(this.rawPtr, out var systemraw);
        ...
        public RESULT @lock(uint offset, uint length, out IntPtr ptr1, out IntPtr ptr2, out uint len1, out uint len2) => FMOD_Sound_Lock(this.rawPtr, offset, length, out ptr1, out ptr2, out len1, out len2);
        public RESULT unlock(IntPtr ptr1, IntPtr ptr2, uint len1, uint len2) => FMOD_Sound_Unlock(this.rawPtr, ptr1, ptr2, len1, len2);
        public RESULT setDefaults(float frequency, int priority) => FMOD_Sound_SetDefaults(this.rawPtr, frequency, priority);
        public RESULT getDefaults(out float frequency, out int priority) => FMOD_Sound_GetDefaults(this.rawPtr, out frequency, out priority);
        public RESULT set3DMinMaxDistance(float min, float max) => FMOD_Sound_Set3DMinMaxDistance(this.rawPtr, min, max);
        public RESULT get3DMinMaxDistance(out float min, out float max) => FMOD_Sound_Get3DMinMaxDistance(this.rawPtr, out min, out max);
        public RESULT set3DConeSettings(float insideconeangle, float outsideconeangle, float outsidevolume) => FMOD_Sound_Set3DConeSettings(this.rawPtr, insideconeangle, outsideconeangle, outsidevolume);
        public RESULT get3DConeSettings(out float insideconeangle, out float outsideconeangle, out float outsidevolume) => FMOD_Sound_Get3DConeSettings(this.rawPtr, out insideconeangle, out outsideconeangle, out outsidevolume);
        public RESULT set3DCustomRolloff(ref VECTOR points, int numpoints) => FMOD_Sound_Set3DCustomRolloff(this.rawPtr, ref points, numpoints);
        public RESULT get3DCustomRolloff(out IntPtr points, out int numpoints) => FMOD_Sound_Get3DCustomRolloff(this.rawPtr, out points, out numpoints);
        public RESULT getSubSound(int index, out Sound subsound) {
            subsound = null;

            var result = FMOD_Sound_GetSubSound(this.rawPtr, index, out var subsoundraw);
        ...
        public RESULT getSubSoundParent(out Sound parentsound) {
            ...
            var result = FMOD_Sound_GetSubSoundParent(this.rawPtr, out var subsoundraw);
        ...
        public RESULT getName(StringBuilder name, int namelen) {
            ...
            var result = FMOD_Sound_GetName(this.rawPtr, stringMem, namelen);
        ...
        public RESULT getLength(out uint length, TIMEUNIT lengthtype) => FMOD_Sound_GetLength(this.rawPtr, out length, lengthtype);
        public RESULT getFormat(out SOUND_TYPE type, out SOUND_FORMAT format, out int channels, out int bits) => FMOD_Sound_GetFormat(this.rawPtr, out type, out format, out channels, out bits);
        public RESULT getNumSubSounds(out int numsubsounds) => FMOD_Sound_GetNumSubSounds(this.rawPtr, out numsubsounds);
        public RESULT getNumTags(out int numtags, out int numtagsupdated) => FMOD_Sound_GetNumTags(this.rawPtr, out numtags, out numtagsupdated);
        public RESULT getTag(string name, int index, out TAG tag) => FMOD_Sound_GetTag(this.rawPtr, name, index, out tag);
        public RESULT getOpenState(out OPENSTATE openstate, out uint percentbuffered, out bool starving, out bool diskbusy) => FMOD_Sound_GetOpenState(this.rawPtr, out openstate, out percentbuffered, out starving, out diskbusy);
        public RESULT readData(IntPtr buffer, uint lenbytes, out uint read) => FMOD_Sound_ReadData(this.rawPtr, buffer, lenbytes, out read);
        public RESULT seekData(uint pcm) => FMOD_Sound_SeekData(this.rawPtr, pcm);
        public RESULT setSoundGroup(SoundGroup soundgroup) => FMOD_Sound_SetSoundGroup(this.rawPtr, soundgroup.getRaw());
        public RESULT getSoundGroup(out SoundGroup soundgroup) {
            soundgroup = null;

            var result = FMOD_Sound_GetSoundGroup(this.rawPtr, out var soundgroupraw);
            soundgroup = new SoundGroup(soundgroupraw);
        ...
        public RESULT getNumSyncPoints(out int numsyncpoints) => FMOD_Sound_GetNumSyncPoints(this.rawPtr, out numsyncpoints);
        public RESULT getSyncPoint(int index, out IntPtr point) => FMOD_Sound_GetSyncPoint(this.rawPtr, index, out point);
        public RESULT getSyncPointInfo(IntPtr point, StringBuilder name, int namelen, out uint offset, TIMEUNIT offsettype) {
            var stringMem = Marshal.AllocHGlobal(name.Capacity);

            var result = FMOD_Sound_GetSyncPointInfo(this.rawPtr, point, stringMem, namelen, out offset, offsettype);
        ...
        public RESULT addSyncPoint(uint offset, TIMEUNIT offsettype, string name, out IntPtr point) => FMOD_Sound_AddSyncPoint(this.rawPtr, offset, offsettype, name, out point);
        public RESULT deleteSyncPoint(IntPtr point) => FMOD_Sound_DeleteSyncPoint(this.rawPtr, point);

        // Functions also in Channel class but here they are the 'default' to save having to change it in Channel all the time.
        public RESULT setMode(MODE mode) => FMOD_Sound_SetMode(this.rawPtr, mode);
        public RESULT getMode(out MODE mode) => FMOD_Sound_GetMode(this.rawPtr, out mode);
        public RESULT setLoopCount(int loopcount) => FMOD_Sound_SetLoopCount(this.rawPtr, loopcount);
        public RESULT getLoopCount(out int loopcount) => FMOD_Sound_GetLoopCount(this.rawPtr, out loopcount);
        public RESULT setLoopPoints(uint loopstart, TIMEUNIT loopstarttype, uint loopend, TIMEUNIT loopendtype) => FMOD_Sound_SetLoopPoints(this.rawPtr, loopstart, loopstarttype, loopend, loopendtype);
        public RESULT getLoopPoints(out uint loopstart, TIMEUNIT loopstarttype, out uint loopend, TIMEUNIT loopendtype) => FMOD_Sound_GetLoopPoints(this.rawPtr, out loopstart, loopstarttype, out loopend, loopendtype);

        // For MOD/S3M/XM/IT/MID sequenced formats only.
        public RESULT getMusicNumChannels(out int numchannels) => FMOD_Sound_GetMusicNumChannels(this.rawPtr, out numchannels);
        public RESULT setMusicChannelVolume(int channel, float volume) => FMOD_Sound_SetMusicChannelVolume(this.rawPtr, channel, volume);
        public RESULT getMusicChannelVolume(int channel, out float volume) => FMOD_Sound_GetMusicChannelVolume(this.rawPtr, channel, out volume);
        public RESULT setMusicSpeed(float speed) => FMOD_Sound_SetMusicSpeed(this.rawPtr, speed);
        public RESULT getMusicSpeed(out float speed) => FMOD_Sound_GetMusicSpeed(this.rawPtr, out speed);

        // Userdata set/get.
        public RESULT setUserData(IntPtr userdata) => FMOD_Sound_SetUserData(this.rawPtr, userdata);
        public RESULT getUserData(out IntPtr userdata) => FMOD_Sound_GetUserData(this.rawPtr, out userdata);
    ...
    */
    public class ChannelControl : HandleBase {
        public RESULT getSystemObject(out System system) {
            ...
            var result = FMOD_ChannelGroup_GetSystemObject(this.rawPtr, out var systemraw);
            system = new System(systemraw);
        ...
        public RESULT stop() => FMOD_ChannelGroup_Stop(this.rawPtr);
        public RESULT setPaused(bool paused) => FMOD_ChannelGroup_SetPaused(this.rawPtr, paused);
        public RESULT getPaused(out bool paused) => FMOD_ChannelGroup_GetPaused(this.rawPtr, out paused);
        public RESULT setVolume(float volume) => FMOD_ChannelGroup_SetVolume(this.rawPtr, volume);
        public RESULT getVolume(out float volume) => FMOD_ChannelGroup_GetVolume(this.rawPtr, out volume);
        public RESULT setVolumeRamp(bool ramp) => FMOD_ChannelGroup_SetVolumeRamp(this.rawPtr, ramp);
        public RESULT getVolumeRamp(out bool ramp) => FMOD_ChannelGroup_GetVolumeRamp(this.rawPtr, out ramp);
        public RESULT getAudibility(out float audibility) => FMOD_ChannelGroup_GetAudibility(this.rawPtr, out audibility);
        public RESULT setPitch(float pitch) => FMOD_ChannelGroup_SetPitch(this.rawPtr, pitch);
        public RESULT getPitch(out float pitch) => FMOD_ChannelGroup_GetPitch(this.rawPtr, out pitch);
        public RESULT setMute(bool mute) => FMOD_ChannelGroup_SetMute(this.rawPtr, mute);
        public RESULT getMute(out bool mute) => FMOD_ChannelGroup_GetMute(this.rawPtr, out mute);
        public RESULT setReverbProperties(int instance, float wet) => FMOD_ChannelGroup_SetReverbProperties(this.rawPtr, instance, wet);
        public RESULT getReverbProperties(int instance, out float wet) => FMOD_ChannelGroup_GetReverbProperties(this.rawPtr, instance, out wet);
        public RESULT setLowPassGain(float gain) => FMOD_ChannelGroup_SetLowPassGain(this.rawPtr, gain);
        public RESULT getLowPassGain(out float gain) => FMOD_ChannelGroup_GetLowPassGain(this.rawPtr, out gain);
        public RESULT setMode(MODE mode) => FMOD_ChannelGroup_SetMode(this.rawPtr, mode);
        public RESULT getMode(out MODE mode) => FMOD_ChannelGroup_GetMode(this.rawPtr, out mode);
        public RESULT setCallback(CHANNEL_CALLBACK callback) => FMOD_ChannelGroup_SetCallback(this.rawPtr, callback);
        public RESULT isPlaying(out bool isplaying) => FMOD_ChannelGroup_IsPlaying(this.rawPtr, out isplaying);

        // Panning and level adjustment.
        public RESULT setPan(float pan) => FMOD_ChannelGroup_SetPan(this.rawPtr, pan);
        public RESULT setMixLevelsOutput(float frontleft, float frontright, float center, float lfe, float surroundleft, float surroundright, float backleft, float backright) => FMOD_ChannelGroup_SetMixLevelsOutput(this.rawPtr, frontleft, frontright, center, lfe,
                surroundleft, surroundright, backleft, backright);
        public RESULT setMixLevelsInput(float[] levels, int numlevels) => FMOD_ChannelGroup_SetMixLevelsInput(this.rawPtr, levels, numlevels);
        public RESULT setMixMatrix(float[] matrix, int outchannels, int inchannels, int inchannel_hop) => FMOD_ChannelGroup_SetMixMatrix(this.rawPtr, matrix, outchannels, inchannels, inchannel_hop);
        public RESULT getMixMatrix(float[] matrix, out int outchannels, out int inchannels, int inchannel_hop) => FMOD_ChannelGroup_GetMixMatrix(this.rawPtr, matrix, out outchannels, out inchannels, inchannel_hop);

        // Clock based functionality.
        public RESULT getDSPClock(out ulong dspclock, out ulong parentclock) => FMOD_ChannelGroup_GetDSPClock(this.rawPtr, out dspclock, out parentclock);
        public RESULT setDelay(ulong dspclock_start, ulong dspclock_end, bool stopchannels) => FMOD_ChannelGroup_SetDelay(this.rawPtr, dspclock_start, dspclock_end, stopchannels);
        public RESULT getDelay(out ulong dspclock_start, out ulong dspclock_end, out bool stopchannels) => FMOD_ChannelGroup_GetDelay(this.rawPtr, out dspclock_start, out dspclock_end, out stopchannels);
        public RESULT addFadePoint(ulong dspclock, float volume) => FMOD_ChannelGroup_AddFadePoint(this.rawPtr, dspclock, volume);
        public RESULT setFadePointRamp(ulong dspclock, float volume) => FMOD_ChannelGroup_SetFadePointRamp(this.rawPtr, dspclock, volume);
        public RESULT removeFadePoints(ulong dspclock_start, ulong dspclock_end) => FMOD_ChannelGroup_RemoveFadePoints(this.rawPtr, dspclock_start, dspclock_end);
        public RESULT getFadePoints(ref uint numpoints, ulong[] point_dspclock, float[] point_volume) => FMOD_ChannelGroup_GetFadePoints(this.rawPtr, ref numpoints, point_dspclock, point_volume);

        // DSP effects.
        public RESULT getDSP(int index, out DSP dsp) {
            dsp = null;

            var result = FMOD_ChannelGroup_GetDSP(this.rawPtr, index, out var dspraw);
            dsp = new DSP(dspraw);

            return result;
        }
        public RESULT addDSP(int index, DSP dsp) => FMOD_ChannelGroup_AddDSP(this.rawPtr, index, dsp.getRaw());
        public RESULT removeDSP(DSP dsp) => FMOD_ChannelGroup_RemoveDSP(this.rawPtr, dsp.getRaw());
        public RESULT getNumDSPs(out int numdsps) => FMOD_ChannelGroup_GetNumDSPs(this.rawPtr, out numdsps);
        public RESULT setDSPIndex(DSP dsp, int index) => FMOD_ChannelGroup_SetDSPIndex(this.rawPtr, dsp.getRaw(), index);
        public RESULT getDSPIndex(DSP dsp, out int index) => FMOD_ChannelGroup_GetDSPIndex(this.rawPtr, dsp.getRaw(), out index);
        public RESULT overridePanDSP(DSP pan) => FMOD_ChannelGroup_OverridePanDSP(this.rawPtr, pan.getRaw());

        // 3D functionality.
        public RESULT set3DAttributes(ref VECTOR pos, ref VECTOR vel, ref VECTOR alt_pan_pos) => FMOD_ChannelGroup_Set3DAttributes(this.rawPtr, ref pos, ref vel, ref alt_pan_pos);
        public RESULT get3DAttributes(out VECTOR pos, out VECTOR vel, out VECTOR alt_pan_pos) => FMOD_ChannelGroup_Get3DAttributes(this.rawPtr, out pos, out vel, out alt_pan_pos);
        public RESULT set3DMinMaxDistance(float mindistance, float maxdistance) => FMOD_ChannelGroup_Set3DMinMaxDistance(this.rawPtr, mindistance, maxdistance);
        public RESULT get3DMinMaxDistance(out float mindistance, out float maxdistance) => FMOD_ChannelGroup_Get3DMinMaxDistance(this.rawPtr, out mindistance, out maxdistance);
        public RESULT set3DConeSettings(float insideconeangle, float outsideconeangle, float outsidevolume) => FMOD_ChannelGroup_Set3DConeSettings(this.rawPtr, insideconeangle, outsideconeangle, outsidevolume);
        public RESULT get3DConeSettings(out float insideconeangle, out float outsideconeangle, out float outsidevolume) => FMOD_ChannelGroup_Get3DConeSettings(this.rawPtr, out insideconeangle, out outsideconeangle, out outsidevolume);
        public RESULT set3DConeOrientation(ref VECTOR orientation) => FMOD_ChannelGroup_Set3DConeOrientation(this.rawPtr, ref orientation);
        public RESULT get3DConeOrientation(out VECTOR orientation) => FMOD_ChannelGroup_Get3DConeOrientation(this.rawPtr, out orientation);
        public RESULT set3DCustomRolloff(ref VECTOR points, int numpoints) => FMOD_ChannelGroup_Set3DCustomRolloff(this.rawPtr, ref points, numpoints);
        public RESULT get3DCustomRolloff(out IntPtr points, out int numpoints) => FMOD_ChannelGroup_Get3DCustomRolloff(this.rawPtr, out points, out numpoints);
        public RESULT set3DOcclusion(float directocclusion, float reverbocclusion) => FMOD_ChannelGroup_Set3DOcclusion(this.rawPtr, directocclusion, reverbocclusion);
        public RESULT get3DOcclusion(out float directocclusion, out float reverbocclusion) => FMOD_ChannelGroup_Get3DOcclusion(this.rawPtr, out directocclusion, out reverbocclusion);
        public RESULT set3DSpread(float angle) => FMOD_ChannelGroup_Set3DSpread(this.rawPtr, angle);
        public RESULT get3DSpread(out float angle) => FMOD_ChannelGroup_Get3DSpread(this.rawPtr, out angle);
        public RESULT set3DLevel(float level) => FMOD_ChannelGroup_Set3DLevel(this.rawPtr, level);
        public RESULT get3DLevel(out float level) => FMOD_ChannelGroup_Get3DLevel(this.rawPtr, out level);
        public RESULT set3DDopplerLevel(float level) => FMOD_ChannelGroup_Set3DDopplerLevel(this.rawPtr, level);
        public RESULT get3DDopplerLevel(out float level) => FMOD_ChannelGroup_Get3DDopplerLevel(this.rawPtr, out level);
        public RESULT set3DDistanceFilter(bool custom, float customLevel, float centerFreq) => FMOD_ChannelGroup_Set3DDistanceFilter(this.rawPtr, custom, customLevel, centerFreq);
        public RESULT get3DDistanceFilter(out bool custom, out float customLevel, out float centerFreq) => FMOD_ChannelGroup_Get3DDistanceFilter(this.rawPtr, out custom, out customLevel, out centerFreq);

        // Userdata set/get.
        public RESULT setUserData(IntPtr userdata) => FMOD_ChannelGroup_SetUserData(this.rawPtr, userdata);
        public RESULT getUserData(out IntPtr userdata) => FMOD_ChannelGroup_GetUserData(this.rawPtr, out userdata);
    ...
    */
    public class Channel : ChannelControl {
        ...
        public RESULT setFrequency(float frequency) => FMOD_Channel_SetFrequency(this.getRaw(), frequency);
        public RESULT getFrequency(out float frequency) => FMOD_Channel_GetFrequency(this.getRaw(), out frequency);
        public RESULT setPriority(int priority) => FMOD_Channel_SetPriority(this.getRaw(), priority);
        public RESULT getPriority(out int priority) => FMOD_Channel_GetPriority(this.getRaw(), out priority);
        public RESULT setPosition(uint position, TIMEUNIT postype) => FMOD_Channel_SetPosition(this.getRaw(), position, postype);
        public RESULT getPosition(out uint position, TIMEUNIT postype) => FMOD_Channel_GetPosition(this.getRaw(), out position, postype);
        public RESULT setChannelGroup(ChannelGroup channelgroup) => FMOD_Channel_SetChannelGroup(this.getRaw(), channelgroup.getRaw());
        public RESULT getChannelGroup(out ChannelGroup channelgroup) {
            channelgroup = null;

            var result = FMOD_Channel_GetChannelGroup(this.getRaw(), out var channelgroupraw);
            channelgroup = new ChannelGroup(channelgroupraw);

            return result;
        }
        public RESULT setLoopCount(int loopcount) => FMOD_Channel_SetLoopCount(this.getRaw(), loopcount);
        public RESULT getLoopCount(out int loopcount) => FMOD_Channel_GetLoopCount(this.getRaw(), out loopcount);
        public RESULT setLoopPoints(uint loopstart, TIMEUNIT loopstarttype, uint loopend, TIMEUNIT loopendtype) => FMOD_Channel_SetLoopPoints(this.getRaw(), loopstart, loopstarttype, loopend, loopendtype);
        public RESULT getLoopPoints(out uint loopstart, TIMEUNIT loopstarttype, out uint loopend, TIMEUNIT loopendtype) => FMOD_Channel_GetLoopPoints(this.getRaw(), out loopstart, loopstarttype, out loopend, loopendtype);

        // Information only functions.
        public RESULT isVirtual(out bool isvirtual) => FMOD_Channel_IsVirtual(this.getRaw(), out isvirtual);
        public RESULT getCurrentSound(out Sound sound) {
            sound = null;

            var result = FMOD_Channel_GetCurrentSound(this.getRaw(), out var soundraw);
            sound = new Sound(soundraw);

            return result;
        }
        public RESULT getIndex(out int index) => FMOD_Channel_GetIndex(this.getRaw(), out index);
    ...
    */
    public class ChannelGroup : ChannelControl {
        public RESULT release() {
            var result = FMOD_ChannelGroup_Release(this.getRaw());
            if (result == RESULT.OK) {
                this.rawPtr = IntPtr.Zero;
            }
            return result;
        ...
        public RESULT addGroup(ChannelGroup group, bool propagatedspclock, out DSPConnection connection) {
            ...
            var result = FMOD_ChannelGroup_AddGroup(this.getRaw(), group.getRaw(), propagatedspclock, out var connectionRaw);
            connection = new DSPConnection(connectionRaw);

            return result;
        }
        public RESULT getNumGroups(out int numgroups) => FMOD_ChannelGroup_GetNumGroups(this.getRaw(), out numgroups);
        public RESULT getGroup(int index, out ChannelGroup group) {
            group = null;

            var result = FMOD_ChannelGroup_GetGroup(this.getRaw(), index, out var groupraw);
        ...
        public RESULT getParentGroup(out ChannelGroup group) {
            ...
            var result = FMOD_ChannelGroup_GetParentGroup(this.getRaw(), out var groupraw);
            group = new ChannelGroup(groupraw);
        ...
        public RESULT getName(StringBuilder name, int namelen) {
            ...
            var result = FMOD_ChannelGroup_GetName(this.getRaw(), stringMem, namelen);
        ...
        public RESULT getNumChannels(out int numchannels) => FMOD_ChannelGroup_GetNumChannels(this.getRaw(), out numchannels);
        public RESULT getChannel(int index, out Channel channel) {
            channel = null;

            var result = FMOD_ChannelGroup_GetChannel(this.getRaw(), index, out var channelraw);
            channel = new Channel(channelraw);
    ...
    */
    public class SoundGroup : HandleBase {
        public RESULT release() {
            var result = FMOD_SoundGroup_Release(this.getRaw());
            if (result == RESULT.OK) {
                this.rawPtr = IntPtr.Zero;
            }
            return result;
        ...
        public RESULT getSystemObject(out System system) {
            ...
            var result = FMOD_SoundGroup_GetSystemObject(this.rawPtr, out var systemraw);
            system = new System(systemraw);
        ...
        public RESULT setMaxAudible(int maxaudible) => FMOD_SoundGroup_SetMaxAudible(this.rawPtr, maxaudible);
        public RESULT getMaxAudible(out int maxaudible) => FMOD_SoundGroup_GetMaxAudible(this.rawPtr, out maxaudible);
        public RESULT setMaxAudibleBehavior(SOUNDGROUP_BEHAVIOR behavior) => FMOD_SoundGroup_SetMaxAudibleBehavior(this.rawPtr, behavior);
        public RESULT getMaxAudibleBehavior(out SOUNDGROUP_BEHAVIOR behavior) => FMOD_SoundGroup_GetMaxAudibleBehavior(this.rawPtr, out behavior);
        public RESULT setMuteFadeSpeed(float speed) => FMOD_SoundGroup_SetMuteFadeSpeed(this.rawPtr, speed);
        public RESULT getMuteFadeSpeed(out float speed) => FMOD_SoundGroup_GetMuteFadeSpeed(this.rawPtr, out speed);
        public RESULT setVolume(float volume) => FMOD_SoundGroup_SetVolume(this.rawPtr, volume);
        public RESULT getVolume(out float volume) => FMOD_SoundGroup_GetVolume(this.rawPtr, out volume);
        public RESULT stop() => FMOD_SoundGroup_Stop(this.rawPtr);

        // Information only functions.
        public RESULT getName(StringBuilder name, int namelen) {
            var stringMem = Marshal.AllocHGlobal(name.Capacity);

            var result = FMOD_SoundGroup_GetName(this.rawPtr, stringMem, namelen);
        ...
        public RESULT getNumSounds(out int numsounds) => FMOD_SoundGroup_GetNumSounds(this.rawPtr, out numsounds);
        public RESULT getSound(int index, out Sound sound) {
            sound = null;

            var result = FMOD_SoundGroup_GetSound(this.rawPtr, index, out var soundraw);
            sound = new Sound(soundraw);

            return result;
        }
        public RESULT getNumPlaying(out int numplaying) => FMOD_SoundGroup_GetNumPlaying(this.rawPtr, out numplaying);

        // Userdata set/get.
        public RESULT setUserData(IntPtr userdata) => FMOD_SoundGroup_SetUserData(this.rawPtr, userdata);
        public RESULT getUserData(out IntPtr userdata) => FMOD_SoundGroup_GetUserData(this.rawPtr, out userdata);
    ...
    */
    public class DSP : HandleBase {
        public RESULT release() {
            var result = FMOD_DSP_Release(this.getRaw());
            if (result == RESULT.OK) {
                this.rawPtr = IntPtr.Zero;
            }
            return result;
        ...
        public RESULT getSystemObject(out System system) {
            ...
            var result = FMOD_DSP_GetSystemObject(this.rawPtr, out var systemraw);
            system = new System(systemraw);
        ...
        public RESULT addInput(DSP target, out DSPConnection connection, DSPCONNECTION_TYPE type) {
            ...
            var result = FMOD_DSP_AddInput(this.rawPtr, target.getRaw(), out var dspconnectionraw, type);
            connection = new DSPConnection(dspconnectionraw);

            return result;
        }
        public RESULT disconnectFrom(DSP target, DSPConnection connection) => FMOD_DSP_DisconnectFrom(this.rawPtr, target.getRaw(), connection.getRaw());
        public RESULT disconnectAll(bool inputs, bool outputs) => FMOD_DSP_DisconnectAll(this.rawPtr, inputs, outputs);
        public RESULT getNumInputs(out int numinputs) => FMOD_DSP_GetNumInputs(this.rawPtr, out numinputs);
        public RESULT getNumOutputs(out int numoutputs) => FMOD_DSP_GetNumOutputs(this.rawPtr, out numoutputs);
        public RESULT getInput(int index, out DSP input, out DSPConnection inputconnection) {
            input = null;
            inputconnection = null;

            var result = FMOD_DSP_GetInput(this.rawPtr, index, out var dspinputraw, out var dspconnectionraw);
        ...
        public RESULT getOutput(int index, out DSP output, out DSPConnection outputconnection) {
            ...
            var result = FMOD_DSP_GetOutput(this.rawPtr, index, out var dspoutputraw, out var dspconnectionraw);
        ...
        // DSP unit control.
        public RESULT setActive(bool active) => FMOD_DSP_SetActive(this.rawPtr, active);
        public RESULT getActive(out bool active) => FMOD_DSP_GetActive(this.rawPtr, out active);
        public RESULT setBypass(bool bypass) => FMOD_DSP_SetBypass(this.rawPtr, bypass);
        public RESULT getBypass(out bool bypass) => FMOD_DSP_GetBypass(this.rawPtr, out bypass);
        public RESULT setWetDryMix(float prewet, float postwet, float dry) => FMOD_DSP_SetWetDryMix(this.rawPtr, prewet, postwet, dry);
        public RESULT getWetDryMix(out float prewet, out float postwet, out float dry) => FMOD_DSP_GetWetDryMix(this.rawPtr, out prewet, out postwet, out dry);
        public RESULT setChannelFormat(CHANNELMASK channelmask, int numchannels, SPEAKERMODE source_speakermode) => FMOD_DSP_SetChannelFormat(this.rawPtr, channelmask, numchannels, source_speakermode);
        public RESULT getChannelFormat(out CHANNELMASK channelmask, out int numchannels, out SPEAKERMODE source_speakermode) => FMOD_DSP_GetChannelFormat(this.rawPtr, out channelmask, out numchannels, out source_speakermode);
        public RESULT getOutputChannelFormat(CHANNELMASK inmask, int inchannels, SPEAKERMODE inspeakermode, out CHANNELMASK outmask, out int outchannels, out SPEAKERMODE outspeakermode) => FMOD_DSP_GetOutputChannelFormat(this.rawPtr, inmask, inchannels, inspeakermode, out outmask, out outchannels, out outspeakermode);
        public RESULT reset() => FMOD_DSP_Reset(this.rawPtr);

        // DSP parameter control.
        public RESULT setParameterFloat(int index, float value) => FMOD_DSP_SetParameterFloat(this.rawPtr, index, value);
        public RESULT setParameterInt(int index, int value) => FMOD_DSP_SetParameterInt(this.rawPtr, index, value);
        public RESULT setParameterBool(int index, bool value) => FMOD_DSP_SetParameterBool(this.rawPtr, index, value);
        public RESULT setParameterData(int index, byte[] data) => FMOD_DSP_SetParameterData(this.rawPtr, index, Marshal.UnsafeAddrOfPinnedArrayElement(data, 0), (uint)data.Length);
        ...
        public RESULT getParameterBool(int index, out bool value) => FMOD_DSP_GetParameterBool(this.rawPtr, index, out value, IntPtr.Zero, 0);
        public RESULT getParameterData(int index, out IntPtr data, out uint length) => FMOD_DSP_GetParameterData(this.rawPtr, index, out data, out length, IntPtr.Zero, 0);
        public RESULT getNumParameters(out int numparams) => FMOD_DSP_GetNumParameters(this.rawPtr, out numparams);
        public RESULT getParameterInfo(int index, out DSP_PARAMETER_DESC desc) {
            var result = FMOD_DSP_GetParameterInfo(this.rawPtr, index, out var descPtr);
            if (result == RESULT.OK) {
        ...
        public RESULT getDataParameterIndex(int datatype, out int index) => FMOD_DSP_GetDataParameterIndex(this.rawPtr, datatype, out index);
        public RESULT showConfigDialog(IntPtr hwnd, bool show) => FMOD_DSP_ShowConfigDialog(this.rawPtr, hwnd, show);
        ...
        public RESULT getInfo(StringBuilder name, out uint version, out int channels, out int configwidth, out int configheight) {
            ...
            var result = FMOD_DSP_GetInfo(this.rawPtr, nameMem, out version, out channels, out configwidth, out configheight);
            StringMarshalHelper.NativeToBuilder(name, nameMem);
            Marshal.FreeHGlobal(nameMem);
            return result;
        }
        public RESULT getType(out DSP_TYPE type) => FMOD_DSP_GetType(this.rawPtr, out type);
        public RESULT getIdle(out bool idle) => FMOD_DSP_GetIdle(this.rawPtr, out idle);

        // Userdata set/get.
        public RESULT setUserData(IntPtr userdata) => FMOD_DSP_SetUserData(this.rawPtr, userdata);
        public RESULT getUserData(out IntPtr userdata) => FMOD_DSP_GetUserData(this.rawPtr, out userdata);

        // Metering.
        public RESULT setMeteringEnabled(bool inputEnabled, bool outputEnabled) => FMOD_DSP_SetMeteringEnabled(this.rawPtr, inputEnabled, outputEnabled);
        public RESULT getMeteringEnabled(out bool inputEnabled, out bool outputEnabled) => FMOD_DSP_GetMeteringEnabled(this.rawPtr, out inputEnabled, out outputEnabled);

        public RESULT getMeteringInfo(DSP_METERING_INFO inputInfo, DSP_METERING_INFO outputInfo) => FMOD_DSP_GetMeteringInfo(this.rawPtr, inputInfo, outputInfo);
    ...
    */
    public class DSPConnection : HandleBase {
        public RESULT getInput(out DSP input) {
            ...
            var result = FMOD_DSPConnection_GetInput(this.rawPtr, out var dspraw);
        ...
        public RESULT getOutput(out DSP output) {
            ...
            var result = FMOD_DSPConnection_GetOutput(this.rawPtr, out var dspraw);
            output = new DSP(dspraw);

            return result;
        }
        public RESULT setMix(float volume) => FMOD_DSPConnection_SetMix(this.rawPtr, volume);
        public RESULT getMix(out float volume) => FMOD_DSPConnection_GetMix(this.rawPtr, out volume);
        public RESULT setMixMatrix(float[] matrix, int outchannels, int inchannels, int inchannel_hop) => FMOD_DSPConnection_SetMixMatrix(this.rawPtr, matrix, outchannels, inchannels, inchannel_hop);
        public RESULT getMixMatrix(float[] matrix, out int outchannels, out int inchannels, int inchannel_hop) => FMOD_DSPConnection_GetMixMatrix(this.rawPtr, matrix, out outchannels, out inchannels, inchannel_hop);
        public RESULT getType(out DSPCONNECTION_TYPE type) => FMOD_DSPConnection_GetType(this.rawPtr, out type);

        // Userdata set/get.
        public RESULT setUserData(IntPtr userdata) => FMOD_DSPConnection_SetUserData(this.rawPtr, userdata);
        public RESULT getUserData(out IntPtr userdata) => FMOD_DSPConnection_GetUserData(this.rawPtr, out userdata);
    ...
    */
    public class Geometry : HandleBase {
        public RESULT release() {
            var result = FMOD_Geometry_Release(this.getRaw());
            if (result == RESULT.OK) {
                this.rawPtr = IntPtr.Zero;
            }
            return result;
        ...
        public RESULT addPolygon(float directocclusion, float reverbocclusion, bool doublesided, int numvertices, VECTOR[] vertices, out int polygonindex) => FMOD_Geometry_AddPolygon(this.rawPtr, directocclusion, reverbocclusion, doublesided, numvertices, vertices, out polygonindex);
        public RESULT getNumPolygons(out int numpolygons) => FMOD_Geometry_GetNumPolygons(this.rawPtr, out numpolygons);
        public RESULT getMaxPolygons(out int maxpolygons, out int maxvertices) => FMOD_Geometry_GetMaxPolygons(this.rawPtr, out maxpolygons, out maxvertices);
        public RESULT getPolygonNumVertices(int index, out int numvertices) => FMOD_Geometry_GetPolygonNumVertices(this.rawPtr, index, out numvertices);
        public RESULT setPolygonVertex(int index, int vertexindex, ref VECTOR vertex) => FMOD_Geometry_SetPolygonVertex(this.rawPtr, index, vertexindex, ref vertex);
        public RESULT getPolygonVertex(int index, int vertexindex, out VECTOR vertex) => FMOD_Geometry_GetPolygonVertex(this.rawPtr, index, vertexindex, out vertex);
        public RESULT setPolygonAttributes(int index, float directocclusion, float reverbocclusion, bool doublesided) => FMOD_Geometry_SetPolygonAttributes(this.rawPtr, index, directocclusion, reverbocclusion, doublesided);
        public RESULT getPolygonAttributes(int index, out float directocclusion, out float reverbocclusion, out bool doublesided) => FMOD_Geometry_GetPolygonAttributes(this.rawPtr, index, out directocclusion, out reverbocclusion, out doublesided);

        // Object manipulation.
        public RESULT setActive(bool active) => FMOD_Geometry_SetActive(this.rawPtr, active);
        public RESULT getActive(out bool active) => FMOD_Geometry_GetActive(this.rawPtr, out active);
        public RESULT setRotation(ref VECTOR forward, ref VECTOR up) => FMOD_Geometry_SetRotation(this.rawPtr, ref forward, ref up);
        public RESULT getRotation(out VECTOR forward, out VECTOR up) => FMOD_Geometry_GetRotation(this.rawPtr, out forward, out up);
        public RESULT setPosition(ref VECTOR position) => FMOD_Geometry_SetPosition(this.rawPtr, ref position);
        public RESULT getPosition(out VECTOR position) => FMOD_Geometry_GetPosition(this.rawPtr, out position);
        public RESULT setScale(ref VECTOR scale) => FMOD_Geometry_SetScale(this.rawPtr, ref scale);
        public RESULT getScale(out VECTOR scale) => FMOD_Geometry_GetScale(this.rawPtr, out scale);
        public RESULT save(IntPtr data, out int datasize) => FMOD_Geometry_Save(this.rawPtr, data, out datasize);

        // Userdata set/get.
        public RESULT setUserData(IntPtr userdata) => FMOD_Geometry_SetUserData(this.rawPtr, userdata);
        public RESULT getUserData(out IntPtr userdata) => FMOD_Geometry_GetUserData(this.rawPtr, out userdata);
    ...
    */
    public class Reverb3D : HandleBase {
        public RESULT release() {
            var result = FMOD_Reverb3D_Release(this.getRaw());
            if (result == RESULT.OK) {
                this.rawPtr = IntPtr.Zero;
            }
            return result;
        ...
        // Reverb manipulation.
        public RESULT set3DAttributes(ref VECTOR position, float mindistance, float maxdistance) => FMOD_Reverb3D_Set3DAttributes(this.rawPtr, ref position, mindistance, maxdistance);
        public RESULT get3DAttributes(ref VECTOR position, ref float mindistance, ref float maxdistance) => FMOD_Reverb3D_Get3DAttributes(this.rawPtr, ref position, ref mindistance, ref maxdistance);
        public RESULT setProperties(ref REVERB_PROPERTIES properties) => FMOD_Reverb3D_SetProperties(this.rawPtr, ref properties);
        public RESULT getProperties(ref REVERB_PROPERTIES properties) => FMOD_Reverb3D_GetProperties(this.rawPtr, ref properties);
        public RESULT setActive(bool active) => FMOD_Reverb3D_SetActive(this.rawPtr, active);
        public RESULT getActive(out bool active) => FMOD_Reverb3D_GetActive(this.rawPtr, out active);

        // Userdata set/get.
        public RESULT setUserData(IntPtr userdata) => FMOD_Reverb3D_SetUserData(this.rawPtr, userdata);
        public RESULT getUserData(out IntPtr userdata) => FMOD_Reverb3D_GetUserData(this.rawPtr, out userdata);
